...
vim.api.nvim_create_user_command(
	"MasonInstallNeeded",
	"MasonInstall bash-language-server dockerfile-language-server json-lsp lua-language-server nixfmt prettier sql-formatter stylua tailwindcss-language-server vtsls vue-language-server yaml-language-server zls",
